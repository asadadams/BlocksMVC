<html>
    <head>
        ...
        <link rel="stylesheet" href='<?php echo PUBLIC_URL;?>/dist/css/main.css'>
    </head>
    <body>
        <div class='main container'>
            ...
            <ul class='links'>
                <li><a href='https://github.com/asadadams/BlocksMVC'>Github</a></li>
                <li><a href='https://www.npmjs.com/package/blocksmvc-cli'>CLI</a></li>
            </ul>
